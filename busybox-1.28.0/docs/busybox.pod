...
Currently available applets include:
	...
	[, [[, ar, arch, arp, awk, base64, basename, bbconfig, beep,
	blkdiscard, blkid, blockdev, bootchartd, bunzip2, bzcat, bzip2, cal,
	cat, chat, chattr, chgrp, chmod, chown, chpst, chroot, chrt, chvt,
	cksum, clear, cmp, comm, cp, cpio, crond, crontab, cttyhack, cut,
	dc, dd, deallocvt, devmem, diff, dirname, dmesg, dnsd,
	dnsdomainname, dos2unix, dpkg, dpkg-deb, du, dumpkmap, echo, ed,
	...
	flashcp, flock, fold, free, freeramdisk, fsfreeze, fstrim, fsync,
	ftpd, ftpget, ftpput, fuser, getopt, grep, gunzip, gzip, halt, hd,
	hdparm, head, hexdump, hexedit, httpd, hwclock, i2cdetect, i2cdump,
	i2cget, i2cset, ifconfig, ifdown, ifup, init, inotifyd, install,
	iostat, ip, ipaddr, ipcalc, iplink, ipneigh, iproute, iprule,
	iptunnel, klogd, less, link, linux32, linux64, linuxrc, ln,
	loadkmap, losetup, lpd, lpq, lpr, ls, lsattr, lsof, lspci, lsscsi,
	lsusb, lzcat, lzma, lzop, makedevs, makemime, man, md5sum, mesg,
	mkdir, mkdosfs, mke2fs, mkfifo, mknod, mkpasswd, mkswap, mktemp,
	modinfo, more, mpstat, mv, nanddump, nbd-client, nc, netstat, nice,
	nl, nmeter, nohup, nproc, nsenter, nuke, od, openvt, partprobe,
	paste, patch, pidof, ping, pipe_progress, pmap, popmaildir,
	poweroff, powertop, printenv, printf, ps, pscan, pstree, pwd, pwdx,
	raidautorun, rdev, readlink, readprofile, realpath, reboot,
	reformime, renice, reset, resize, resume, rev, rm, rmdir, route,
	rpm, rpm2cpio, rtcwake, run-init, run-parts, runsv, runsvdir, rx,
	script, scriptreplay, sed, sendmail, seq, setconsole, setfattr,
	setkeycodes, setlogcons, setpriv, setserial, setsid, setuidgid, sh,
	sha1sum, sha256sum, sha3sum, sha512sum, showkey, shred, shuf, sleep,
	smemcap, softlimit, sort, split, ssl_client, start-stop-daemon,
	strings, stty, sum, sv, svc, svlogd, switch_root, sync, sysctl, tac,
	tail, tar, tcpsvd, tee, telnet, telnetd, test, tftp, tftpd, timeout,
	top, touch, tr, traceroute, true, truncate, ttysize, tunctl,
	tune2fs, ubirename, udhcpc, udpsvd, uevent, uname, uncompress,
	unexpand, uniq, unix2dos, unlink, unlzma, unshare, unxz, unzip,
	uptime, usleep, uudecode, uuencode, vconfig, vi, volname, watch, wc,
...
tar c|x|t [-ZzJjahmvO] [-f TARFILE] [-C DIR] [-T FILE] [-X FILE] [FILE]...
...
wget [-cq] [-O FILE] [-Y on/off] [-P DIR] [-S] [-U AGENT] [-T SEC] URL...
